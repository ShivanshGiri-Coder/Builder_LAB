      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-4 mb-8">
            ...
            <Link
              href="/export/pdf"
              className="bg-gradient-to-r from-red-600/80 to-orange-600/80 hover:from-red-500/80 hover:to-orange-500/80 text-white font-semibold rounded-xl p-6 transition-all duration-200 border border-red-500/30 hover:border-red-500/50 flex items-center justify-center gap-3"
            >
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
