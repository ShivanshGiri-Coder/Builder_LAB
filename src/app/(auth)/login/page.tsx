    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="bg-gray-900/80 border border-gray-800 rounded-2xl p-8 shadow-xl shadow-purple-500/5 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button type="button" className="h-12 flex items-center justify-center bg-gray-800/50 border border-gray-700 hover:bg-gray-700/50 text-white rounded-xl transition-all">
